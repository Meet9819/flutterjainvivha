...
class LightColor {
  ...
  static const Color primaryBackground =  const Color.fromRGBO(238, 38, 84, 1);
  static const Color titleTextColor = const Color.fromRGBO(1, 4, 99,0);
  ...
  static const Color yellowColor = Color.fromRGBO(238, 38, 84, 1);
